...
part of 'best_seller_data.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<BestSellerData> _$bestSellerDataSerializer =
    new _$BestSellerDataSerializer();

class _$BestSellerDataSerializer
    implements StructuredSerializer<BestSellerData> {
  @override
  final Iterable<Type> types = const [BestSellerData, _$BestSellerData];
  @override
  final String wireName = 'BestSellerData';

  @override
  Iterable<Object> serialize(Serializers serializers, BestSellerData object,
    ...
    if (object.links != null) {
      result
        ...
        ..add(serializers.serialize(object.links,
            specifiedType: const FullType(BestSellerLinks)));
    }
    return result;
  }

  @override
  BestSellerData deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new BestSellerDataBuilder();
...
class _$BestSellerData extends BestSellerData {
  @override
  final String name;
  @override
  ...
  final int sales;
  @override
  final BestSellerLinks links;

  factory _$BestSellerData([void Function(BestSellerDataBuilder) updates]) =>
      (new BestSellerDataBuilder()..update(updates)).build();
  ...
  @override
  BestSellerData rebuild(void Function(BestSellerDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  BestSellerDataBuilder toBuilder() =>
      new BestSellerDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is BestSellerData &&
        name == other.name &&
        photos == other.photos &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('BestSellerData')
          ..add('name', name)
          ..add('photos', photos)
...
class BestSellerDataBuilder
    implements Builder<BestSellerData, BestSellerDataBuilder> {
  _$BestSellerData _$v;
  ...
  BestSellerLinksBuilder _links;
  BestSellerLinksBuilder get links =>
      _$this._links ??= new BestSellerLinksBuilder();
  set links(BestSellerLinksBuilder links) => _$this._links = links;

  BestSellerDataBuilder();

  BestSellerDataBuilder get _$this {
    if (_$v != null) {
      _name = _$v.name;
  ...
  @override
  void replace(BestSellerData other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$BestSellerData;
  }

  @override
  void update(void Function(BestSellerDataBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$BestSellerData build() {
    _$BestSellerData _$result;
    try {
      _$result = _$v ??
          new _$BestSellerData._(
              name: name,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'BestSellerData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
