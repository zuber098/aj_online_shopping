...
part of 'related_product_data.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<RelatedProductData> _$relatedProductDataSerializer =
    new _$RelatedProductDataSerializer();

class _$RelatedProductDataSerializer
    implements StructuredSerializer<RelatedProductData> {
  @override
  final Iterable<Type> types = const [RelatedProductData, _$RelatedProductData];
  @override
  final String wireName = 'RelatedProductData';

  @override
  Iterable<Object> serialize(Serializers serializers, RelatedProductData object,
    ...
    if (object.links != null) {
      result
        ...
        ..add(serializers.serialize(object.links,
            specifiedType: const FullType(RelatedProductLinks)));
    }
    return result;
  }

  @override
  RelatedProductData deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new RelatedProductDataBuilder();
...
class _$RelatedProductData extends RelatedProductData {
  @override
  final String name;
  @override
  ...
  factory _$RelatedProductData(
          [void Function(RelatedProductDataBuilder) updates]) =>
      (new RelatedProductDataBuilder()..update(updates)).build();

  _$RelatedProductData._(
      {this.name,
      this.photos,
      this.thumbnailImage,
      this.featuredImage,
  ...
  @override
  RelatedProductData rebuild(
          void Function(RelatedProductDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RelatedProductDataBuilder toBuilder() =>
      new RelatedProductDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RelatedProductData &&
        name == other.name &&
        photos == other.photos &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('RelatedProductData')
          ..add('name', name)
          ..add('photos', photos)
...
class RelatedProductDataBuilder
    implements Builder<RelatedProductData, RelatedProductDataBuilder> {
  _$RelatedProductData _$v;
  ...
  RelatedProductLinksBuilder _links;
  RelatedProductLinksBuilder get links =>
      _$this._links ??= new RelatedProductLinksBuilder();
  set links(RelatedProductLinksBuilder links) => _$this._links = links;

  RelatedProductDataBuilder();

  RelatedProductDataBuilder get _$this {
    if (_$v != null) {
      _name = _$v.name;
  ...
  @override
  void replace(RelatedProductData other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$RelatedProductData;
  }

  @override
  void update(void Function(RelatedProductDataBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$RelatedProductData build() {
    _$RelatedProductData _$result;
    try {
      _$result = _$v ??
          new _$RelatedProductData._(
              name: name,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'RelatedProductData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
