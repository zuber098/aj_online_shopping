...
part of 'category_response_data.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<CategoryResponseData> _$categoryResponseDataSerializer =
    new _$CategoryResponseDataSerializer();

class _$CategoryResponseDataSerializer
    implements StructuredSerializer<CategoryResponseData> {
  @override
  ...
  @override
  final String wireName = 'CategoryResponseData';

  @override
  Iterable<Object> serialize(
      Serializers serializers, CategoryResponseData object,
    ...
    if (object.links != null) {
      result
        ...
        ..add(serializers.serialize(object.links,
            specifiedType: const FullType(CategoryResponseDataLinks)));
    }
    return result;
  }

  @override
  CategoryResponseData deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new CategoryResponseDataBuilder();
...
class _$CategoryResponseData extends CategoryResponseData {
  @override
  final String name;
  @override
  ...
  final int sales;
  @override
  final CategoryResponseDataLinks links;

  factory _$CategoryResponseData(
          [void Function(CategoryResponseDataBuilder) updates]) =>
      (new CategoryResponseDataBuilder()..update(updates)).build();

  _$CategoryResponseData._(
      {this.name,
      this.photos,
      this.thumbnailImage,
      this.featuredImage,
  ...
  @override
  CategoryResponseData rebuild(
          void Function(CategoryResponseDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CategoryResponseDataBuilder toBuilder() =>
      new CategoryResponseDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CategoryResponseData &&
        name == other.name &&
        photos == other.photos &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CategoryResponseData')
          ..add('name', name)
          ..add('photos', photos)
...
class CategoryResponseDataBuilder
    implements Builder<CategoryResponseData, CategoryResponseDataBuilder> {
  _$CategoryResponseData _$v;
  ...
  CategoryResponseDataLinksBuilder _links;
  CategoryResponseDataLinksBuilder get links =>
      _$this._links ??= new CategoryResponseDataLinksBuilder();
  set links(CategoryResponseDataLinksBuilder links) => _$this._links = links;

  CategoryResponseDataBuilder();

  CategoryResponseDataBuilder get _$this {
    if (_$v != null) {
      _name = _$v.name;
  ...
  @override
  void replace(CategoryResponseData other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$CategoryResponseData;
  }

  @override
  void update(void Function(CategoryResponseDataBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$CategoryResponseData build() {
    _$CategoryResponseData _$result;
    try {
      _$result = _$v ??
          new _$CategoryResponseData._(
              name: name,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'CategoryResponseData', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
