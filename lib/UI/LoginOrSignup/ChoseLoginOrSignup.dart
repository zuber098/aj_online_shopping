                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  AppLocalizations.of(context).tr('hintChoseLogin'),
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 17.0,
                              ...
                              tapLogin == 0
                                  ? Material(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: ButtonCustom(txt: AppLocalizations.of(context).tr('signUp')),
                                      ),
                                    )
                          ...
                          tapSignup == 0
                              ? Material(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: ButtonCustom(txt: AppLocalizations.of(context).tr('login')),
                                  ),
                                )
