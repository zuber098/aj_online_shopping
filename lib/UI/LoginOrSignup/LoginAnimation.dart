...
import 'package:ajonlineshope/UI/LoginOrSignup/LoginLoadingScreen.dart';
...
class LoginAnimation extends StatefulWidget {
  ...
  MainApi mainApi;
  bool isLogin;
  LoginAnimation({Key key, this.animationController,this.mainApi,this.isLogin})
      : animation = new Tween(
          end: 900.0,
          begin: 70.0,
  ...
  Widget build(BuildContext context) {
    ...
    widget.animationController.addListener(() {
      ...
      /*  Navigator.of(context).pushReplacement(MaterialPageRoute(
        ...
        Navigator.of(context).pushReplacement(MaterialPageRoute(
            builder: (BuildContext context) => new LoginLoadingScreen(mainApi: widget.mainApi,isLogin: widget.isLogin,)));
