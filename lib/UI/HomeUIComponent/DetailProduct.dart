...
import 'package:ajonlineshope/main.dart';
...
import 'package:ajonlineshope/UI/HomeUIComponent/ChatItem.dart';
import 'package:ajonlineshope/UI/CartUIComponent/Delivery.dart';
import 'package:flutter_html/flutter_html.dart';

import 'package:flutter_rating/flutter_rating.dart';
import 'package:ajonlineshope/UI/HomeUIComponent/ReviewLayout.dart';
...
//  BestSellerData bestSellerData;
  ...
  detailProduk(/*this.bestSellerData*/ this.productDetailsLink);

  @override
  _detailProdukState createState() =>
      _detailProdukState(/*bestSellerData*/ productDetailsLink);
}
...
//  BestSellerData bestSellerData;
  ...
  _detailProdukState(this.productDetailsLink);
  ...
  @override
  void initState() {
    print("Product link: $productDetailsLink");
    getProductDetails();
  ...
  Widget build(BuildContext context) {
          ...
          children: <Widget>[
            ...
            Expanded(
              child: ListView(
                ...
                children: <Widget>[
                  if (relatedProductResponseModel != null)
                    (Row(
                      children: relatedProductResponseModel.data
                          .map(
                            (item) => FavoriteItem(
                              image: item
                                  .thumbnailImage /*"assets/imgItem/shoes1.jpg"*/,
                              title: item
                                  .name /*AppLocalizations.of(context).tr('productTitle1')*/,
                              Salary: "\$ ${item.basePrice}",
                              Rating: "${item.rating}",
                              sale: "${item.sales} sold",
                              productLink: relatedProductResponseModel
                                  .data[0].links.details,
                            ),
                          )
                          .toList(),
                    )),
    ...
    return EasyLocalizationProvider(
      ...
      child: Scaffold(
        ...
        body: productDetailsResponseModel != null
            ? Column(
                children: <Widget>[
                  Flexible(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Hero(
                              tag:
                                  "hero-grid-${productDetailsResponseModel.data[0].name}",
                              child: Material(
                                child: new Carousel(
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    productDetailsResponseModel.data[0].name,
                                    style: _customTextStyle,
                                  ),
                                  Padding(padding: EdgeInsets.only(top: 5.0)),
                                  Text(
                                    "\$ ${productDetailsResponseModel.data[0].priceLower}",
                                    style: _customTextStyle,
                                  ),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Html(
                                        ...
                                        data: productDetailsResponseModel
                                            .data[0].description,
                                        /*   style: _detailText*/
                                      ),
                                    ),
                          ...
                          relatedProductResponseModel != null
                              ? _suggestedItem
                              : CustomLoader(
            ...
            : CustomLoader(color: Colors.blueAccent),
      ),
    );
  }
  ...
  void getProductDetails() async {
    try {
      ...
      Response response =
          await mainApi.getProductDetails(context, productDetailsLink);

      if (response != null) {
        setState(() {
          productDetailsResponseModel =
              ProductDetailsResponseModel.fromJson(response.toString());

          for (int i = 0;
              i < productDetailsResponseModel.data[0].photos.length;
              i++) {
            sliderImages.add(NetworkImage(
                ASSET_URL + productDetailsResponseModel.data[0].photos[i]));
          }

          getProductReviews(productDetailsResponseModel.data[0].links.reviews);
          getRelatedProduct(productDetailsResponseModel.data[0].links.related);
        });
      }
    } catch (e) {
      print(e);
  ...
  void getProductReviews(String link) async {
    try {

      MainApi mainApi = new MainApi(context);
      Response response = await mainApi.getProductReview(context, link);
    } catch (e) {
      print(e);
    }
  }

  void getRelatedProduct(String link) async {
    try {
      MainApi mainApi = new MainApi(context);
      Response response = await mainApi.getRelatedProduct(context, link);
      if (response != null) {
        setState(() {
          relatedProductResponseModel =
              RelatedProductResponseModel.fromJson(response.toString());
        });
      }
    } catch (e) {
      print(e);
  ...
  void addToCart() async{
    int productId = productDetailsResponseModel.data[0].id;
    MainApi mainApi = new MainApi.AddToCart(context: context,productId: productId);
    Response response = await mainApi.addToCart(context);
  }
}
...
class FavoriteItem extends StatelessWidget {
  String image, Rating, Salary, title, sale, productLink;
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (xzt) => detailProduk(productLink)));
      },
      child: Padding(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(ASSET_URL + image),
                            fit: BoxFit.cover)),
                  ),
