...
import 'package:ajonlineshope/ListItem/MenuItem.dart';
  ...
  Widget build(BuildContext context) {
    ...
    var _promoHorizontalList = Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
              padding: EdgeInsets.only(left: 20.0, top: 10.0, bottom: 3.0,right: 20.0),
              child: Text(AppLocalizations.of(context).tr('weekPromotion'), style: _customTextStyleBlack)),
          Expanded(
            child: ListView(
              shrinkWrap: true,
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                InkWell(
                  onTap: null,
                  child: Text(AppLocalizations.of(context).tr('seeMore'), style: _customTextStyleBlue),
                ),
              ],
            ),
          ),
