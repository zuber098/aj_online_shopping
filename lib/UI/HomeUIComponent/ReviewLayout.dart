...
import 'package:ajonlineshope/Library/Expanded/ExpandedDetailRatting.dart';
import 'package:ajonlineshope/Library/Expanded/ExpandedDetailReviews.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child:  Text(AppLocalizations.of(context).tr('reviewsAppBar'),style: TextStyle(color: Colors.black,fontSize: 20.0,fontFamily: "Popins",fontWeight: FontWeight.w700),),
                  ),
                  Padding(
                  ...
                  ListTile(
                    ...
                    subtitle:  ExpansionTileReview(
                      title:Text(
                        AppLocalizations.of(context).tr('ratingReview'),style: _detailText,
                      ),
                      children:[
                        SizedBox(height: 10.0),
                        Text(AppLocalizations.of(context).tr('ratingReview2'),style: _detailText,),
                        SizedBox(height: 10.0),
                        Text(AppLocalizations.of(context).tr('ratingReview'),style: _detailText,),
                      ],
                  ...
                  Column(
                    children: <Widget>[
                      ExpansionTileCustomRatting(
                        title:    _buildRating( AppLocalizations.of(context).tr('date'),
                       AppLocalizations.of(context).tr('ratingReview'),
                                (rating) {
                              setState(() {
                                this.rating = rating;
